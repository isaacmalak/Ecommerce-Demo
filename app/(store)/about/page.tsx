    ...
    <section className="mx-auto max-w-3xl px-4 py-10">
      <header className="mb-8 text-center">
        ...
        <p className="text-lg text-gray-500">
          Welcome to <strong>El S7s Group</strong>, the ultimate destination for
          collectors, fans, and the young at heart. Whether you are hunting for
          that elusive chase variant, building a 1/12 scale army, or just
      ...
      <section className="mb-10">
        ...
        <p className="mb-2">
          ...
          realized that buying action figures online was often a gamble. Between
          crushed boxes, delayed pre-orders, and impersonal service, the joy of
          &quot;the hunt&quot; was getting lost. We decided to change that.
        </p>
        <p>
          We set out to build the toy store we always wanted to shop at—one that
          respects the art of the collectible and the passion of the fan. From a
          humble beginning in a [garage/small room/market stall], we have grown
          into a community hub serving thousands of happy customers worldwide.
        </p>
      </section>

      <section className="mb-10 rounded-lg p-6">
        <h2 className="mb-2 text-2xl font-semibold">The Collector’s Pledge</h2>
        <p className="mb-4">
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc space-y-2 pl-6">
          ...
          <li>
            <strong>Anime &amp; Manga:</strong> Figma, Nendoroid, and Banpresto
            statues.
          </li>
          <li>
      ...
      <section className="mb-10 rounded-lg p-6">
        ...
        <p className="mb-2">
          ...
          and collectors. If you have a question about a pre-order, need advice
          on a gift, or just want to debate who is the best Batman, reach out to
          us. We love talking shop.
        </p>
        <p>
          Thank you for choosing <strong>El S7s Group</strong> to build your
          collection.
        </p>
        <blockquote className="mt-4 border-l-4 border-red-400 pl-4 text-red -700 italic">
      ...
      <section>
        ...
        <ul className="mb-4 list-disc space-y-2 pl-6">
          ...
          <li>
            ...
            adjust the &quot;What We Carry&quot; section to reflect your actual
            inventory.
          </li>
          <li>
            Add Photos: An About page works best with photos of your warehouse,
            your shelves, or your team packing boxes. It builds trust.
          </li>
        </ul>
        <p>
